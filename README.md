...
<img src="client/public/favicon.svg" alt="AImage Logo" width="180"/>

# ✨ Aimage - AI Transforming Your Images Magically ✨
...
```bash
git clone https://github.com/satish-chau95/AImage.git
cd AImage
```
...
| `MONGODB_URI` | MongoDB connection string | `mongodb+srv://username:password@cluster.mongodb.net/AImage` |
