            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
                <div className="grid grid-cols-2 md:grid-cols-12 gap-6">
                    ...
                    <div className="col-span-2 md:col-span-4">
                        <div className="flex items-center gap-2 mb-3">
                            ...
                            <span className="text-lg font-medium">AImage</span>
                        </div>
                        <p className="text-gray-600 text-sm leading-relaxed mb-4">
                            Turn your imagination into visual art in seconds with our AI-powered platform.
                        </p>
                        <div className="flex items-center gap-3">
                            <a href="https://github.com/satish-chau95" className="w-8 h-8 flex items-center justify-center rounded-full border border-gray-200 hover:border-gray-400 transition-colors">
                                <img src={assets.github_icon} alt="github" className="w-4 h-4" />
                            </a>
                            <a href="https://linkedin.com/in/satish-chau95" className="w-8 h-8 flex items-center justify-center rounded-full border border-gray-200 hover:border-gray-400 transition-colors">
                                <img src={assets.linkedin_icon} alt="linkedin" className="w-4 h-4" />
                            </a>
                            <a href="https://instagram.com/satishchaurasia95" className="w-8 h-8 flex items-center justify-center rounded-full border border-gray-200 hover:border-gray-400 transition-colors">
                ...
                <div className="mt-8 pt-4 text-center border-t border-gray-100">
                    <p className="text-sm text-gray-600">
                        © {currentYear} AImage. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
